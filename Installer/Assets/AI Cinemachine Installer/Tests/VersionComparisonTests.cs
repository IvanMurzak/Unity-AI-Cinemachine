...
using com.IvanMurzak.Unity.MCP.Cinemachine.Installer.SimpleJSON;

namespace com.IvanMurzak.Unity.MCP.Cinemachine.Installer.Tests
{
    public class VersionComparisonTests
    {
        const string TestManifestPath = "Temp/com.IvanMurzak.Unity.MCP.Cinemachine.Installer.Tests/test_manifest.json";
        const string PackageId = "com.ivanmurzak.unity.mcp.cinemachine";
