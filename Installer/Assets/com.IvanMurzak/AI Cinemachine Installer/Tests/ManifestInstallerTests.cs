...
namespace com.IvanMurzak.Unity.MCP.Cinemachine.Installer.Tests
{
    public class ManifestInstallerTests
    {
        ...
        const string FilesRoot = "Assets/com.IvanMurzak/AI Cinemachine Installer/Tests/Files";
        const string FilesCopyRoot = "Temp/com.IvanMurzak/AI Cinemachine Installer/Tests/Files";
