...
#### 3️⃣ Customize `Packages/com.ivanmurzak.unity.mcp.cinemachine/package.json`
...
- 👉 **Delete** `Packages/com.ivanmurzak.unity.mcp.cinemachine/Tests` folder
...
#### 4️⃣ Add files into `Packages/com.ivanmurzak.unity.mcp.cinemachine` folder
...
- Copy the updated `README.md` to `Packages/com.ivanmurzak.unity.mcp.cinemachine` as well.
