...
#### 1️⃣ Customize `Packages/com.ivanmurzak.unity.mcp.cinemachine/package.json`
...
<details>
  ...
  - Update the files:
    - `Packages/com.ivanmurzak.unity.mcp.cinemachine/Tests/Base/Package.Editor.Tests.asmdef`
    - `Packages/com.ivanmurzak.unity.mcp.cinemachine/Tests/Base/Package.Tests.asmdef`
