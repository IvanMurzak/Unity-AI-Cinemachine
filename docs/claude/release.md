...
- Reads the current version from `Unity-Package/Packages/com.ivanmurzak.unity.mcp.cinemachine/package.json`.
- Updates these files atomically:
  - `Unity-Package/Packages/com.ivanmurzak.unity.mcp.cinemachine/package.json` — `"version": "X.Y.Z"`
